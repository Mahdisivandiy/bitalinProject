...
const MainLayout = () => {
  ...
  return (
    <section className="2xl:container md:container my-[140-px] text-black py-[70px] rtl ">
      <div className="grid grid-cols-1 md:grid-cols-12  grid-rows-12 md:gap-[30px]  gap-[8px] md:gap-[30px]  gap-[8px]">
        ...
        <section className="col-start-1 md:col-span-3 row-start-4 md:row-start-1 md:row-span-1   bg-white md:rounded-lg bg-white md:rounded-lg">
          {' '}
          <Tabs
            className="w-100 "
        ...
        <section className="col-start-1 col-span-3 row-start-2 row-span-2 self-start bg-white md:rounded-xl hidden md:flex flex-col leading-[28px]	p-[24px] gap-[24px] items-end">
          {' '}
        ...
        <section className=" md:col-start-4 md:col-span-9 self-start md:row-start-1 md:bg-white   md:row-span-2   md:rounded-lg md:shadow-xl  ">
